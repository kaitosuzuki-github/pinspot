module ApplicationHelper
  ...
  def create_follow_button(user_id)
    if !user_signed_in?
      return button_to "フォローする", user_relationships_path(user_id), id: "follow_button", class: "follow-button",
  ...
  def create_avatar_elements(avatar, size)
    tag.div id: "avatar_display", class: "#{size} rounded-full overflow-hidden" do
      if avatar.attached?
